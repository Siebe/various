==============================================================================
        ...
        hiir - An oversampling and Hilbert transform library in C++
        v1.00
...
of code. So far, it has been built and tested on:
     ...
     - MS Windows / MS Visual C++ Toolkit 2003 (FPU/SSE/3DNow)
     - MS Windows / GCC 3.3 (FPU only)
...
Efficient Interpolation and Decimation", IEE Proceedings, Dec 1983

- Artur Krukowski, "Polyphase Filter Designer in Java"
...
to use the library ; they are not needed to use hiir in your own programs.
...
Debug mode:
g++ -Wall -o hiir_debug.exe *.cpp

Release mode:
g++ -Wall -o hiir_release.exe -DNDEBUG -O3 *.cpp
...
test_conf.h file, in order to select the instruction sets available for your
...
bigger by reducing the transition bandwidth.
