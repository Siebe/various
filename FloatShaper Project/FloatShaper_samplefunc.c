...
instantiateFloatShaper(const LADSPA_Descriptor * Descriptor,
  ...
  psFloatShaper->m_fDelaySize = (SampleRate * (LADSPA_Data) MAXDELAY * 0.001 );
  ...
  psFloatShaper->m_fSRinMS = (SampleRate * 0.001);  
...
/*****************************************************************************/
LADSPA_Data processSampleFS(LADSPA_Handle Instance, LADSPA_Data input) {
